...
// It tells "WHAT a system does" not "HOW it does it".

// Ways to achieve Abstraction:
// 1. Abstract Classes (with pure virtual functions)
// 2. Interfaces (abstract class with only pure virtual methods)
// 3. Access Modifiers (private/protected to hide internal details)
*/
class Car
{
public:
...
int main()
{
    ...
    Car *myCar = new SportsCar("Ford", "Mustang"); // objec tis created of pointer class and then pointed to diff diff child classes
